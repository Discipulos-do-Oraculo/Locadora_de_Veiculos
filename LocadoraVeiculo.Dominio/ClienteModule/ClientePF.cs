...
namespace LocadoraVeiculo.Dominio.ClienteModule
{
    public class ClientePF:Pessoa
    {
        ...
        public ClientePF(int id, string nome, string endereco, string email, string cidade, string estado, string telefone, string rg, string cpf, string cnh, DateTime validadecnh)
        {
            Id = id;
            Nome = nome;
            Endereco = endereco;
