...
namespace LocadoraVeiculo.Dominio.DevolucaoModule
{
    public class Devolucao : EntidadeBase
    {
        ...
        private TaxasEServicos taxas;
        private DateTime dataRetorno;
        private int kmFinal, litrosGastos;
        private double valorTotal;

        public Devolucao(Locacao locacao, Combustivel tipoCombustivel, TaxasEServicos taxas, DateTime dataRetorno, int kmFinal, int litrosGastos, double valorTotal)
        {
            Locacao = locacao;
        ...
        public TaxasEServicos Taxas { get => taxas; set => taxas = value; }
        public DateTime DataRetorno { get => dataRetorno; set => dataRetorno = value; }
        public int KmFinal { get => kmFinal; set => kmFinal = value; }
        public int LitrosGastos { get => litrosGastos; set => litrosGastos = value; }
        ...
        public override bool Equals(object obj)
        {
            return obj is Devolucao devolucao &&
                   ...
                   EqualityComparer<TaxasEServicos>.Default.Equals(taxas, devolucao.taxas) &&
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<TaxasEServicos>.Default.GetHashCode(taxas);
        ...
        public override string Validar()
        {
            ...
            if (taxas == null)
                resultadoValidacao = "Selecione uma taxa para realizar devolução";
