...
namespace LocadoraVeiculos.Test
{
    ...
    public class GrupoDeVeiculosControladorTest
    {
        ...
        {
            //arrange
            var novoGrupoDeVeiculos = new GrupoDeVeiculos("SUV", 50, 20, 30, 40, 50,20);
        ...
        public void DeveAtualizar_GrupoDeVeiculos()
        {
            ...
            var novoGrupoDeVeiculos = new GrupoDeVeiculos("Esportivo", 50, 20, 30, 40, 50,20);
        ...
        {
            //arrange
            var gv1 = new GrupoDeVeiculos("SUV", 50, 20, 30, 40, 50,20);
            controlador.InserirNovo(gv1);

            var gv2 = new GrupoDeVeiculos("Esportivo", 50, 20, 30, 40, 50,02);
            controlador.InserirNovo(gv2);

            var gv3 = new GrupoDeVeiculos("Utilitário", 50, 20, 30, 40, 50,02);
